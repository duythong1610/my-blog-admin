...
export function sortByKeyAscending<T extends GenericObject, K extends keyof T>(
  array: T[],
  key: K
): T[] {
...
export function sortByKeyDescending<T extends GenericObject, K extends keyof T>(
  array: T[],
  key: K
): T[] {
  return array.slice().sort((a, b) => {
